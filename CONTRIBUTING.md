...
Welcome to `poc-minio-s3-select-python` contributor's guide.
...
If you experience bugs or general issues with `poc-minio-s3-select-python`, please have a look
...
You can help improve `poc-minio-s3-select-python` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`poc-minio-s3-select-python` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `poc-minio-s3-select-python`'s files. While this mechanism can
...
```
conda create -n poc-minio-s3-select-python python=3 six virtualenv pytest pytest-cov
conda activate poc-minio-s3-select-python
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/poc-minio-s3-select-python.git
   cd poc-minio-s3-select-python
   ```
...
5. Install [pre-commit]:
   ...
   `poc-minio-s3-select-python` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/poc-minio-s3-select-python
[issue tracker]: https://github.com/<USERNAME>/poc-minio-s3-select-python/issues
